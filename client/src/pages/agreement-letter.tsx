...
export default function AgreementLetter() {
  return (
    <div style={{ fontFamily: "'Courier New', monospace", margin: 0, padding: '5px', backgroundColor: '#fafafa', fontSize: '11px', lineHeight: 1 }}>
      <div style={{ width: '910px', margin: '0 auto', backgroundColor: 'white', border: '8px solid #fff', padding: 0 }}>
        ...
        <div style={{ padding: '15px' }}>
          ...
          <div style={{ display: 'flex', marginBottom: '8px', alignItems: 'flex-start' }}>
            ...
            <div style={{ flex: 1, borderBottom: '1px solid #000', minHeight: '16px', paddingLeft: '3px', fontSize: '10px' }}>500 or 1000 Package Expected</div>
          </div>
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', margin: '6px 0', fontSize: '9px' }}>
            <div style={{ width: '12px', height: '12px', border: '1px solid #000', marginRight: '8px', flexShrink: 0, marginTop: '2px' }}></div>
            MUST COMPLETE 500 OR 1000 ITEMS WEEKLY
          </div>
